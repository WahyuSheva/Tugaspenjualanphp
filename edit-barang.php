...
<body>
    ...
    <form action ="proses-edit-barang.php" method="POST">
        <fieldset>
            <input type="hidden" nama="id" value="<?php echo $barang['id']?>" />
            <p>
                <label name="nama">Nama Barang : </label>
                <input type="text" value= "<?php echo $barang['nama']?>" /></p>

                <p>
                <label name="stok">Stok Barang : </label>
                <input type="number" value="<?php echo $barang['stok']?>" /></p>

                <p>
                <label name="nama">Harga Barang : </label>
                <input type="number" value="<?php echo $barang['harga']?>" /></p>
